...
from llm.base import ChatSequence
from llm.providers.openai import OPEN_AI_MODELS
from llm.utils import count_string_tokens, create_chat_completion
...
if __name__ == "__main__":
    # Test the function
    text = "This is a test of the text condenser. It should split this text into chunks that fit within the model's token limit. The limit is 2048 tokens for the gpt-neo-2.7B model. This text is 64 t"
    # chunks = split_text(text, "gpt-neo-2.7B", Config())
    # Samp
    # else summarize_text(
